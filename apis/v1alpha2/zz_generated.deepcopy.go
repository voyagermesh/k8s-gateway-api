...
func (in *BackendTLSPolicyConfig) DeepCopyInto(out *BackendTLSPolicyConfig) {
	*out = *in
	if in.CACertRefs != nil {
		...
		*out = make([]LocalCACertReference, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalCACertReference) DeepCopyInto(out *LocalCACertReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalCACertReference.
func (in *LocalCACertReference) DeepCopy() *LocalCACertReference {
	if in == nil {
		return nil
	}
	out := new(LocalCACertReference)
	in.DeepCopyInto(out)
	return out
}
