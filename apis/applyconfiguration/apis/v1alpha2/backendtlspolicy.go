...
// Experimental!
func ExtractBackendTLSPolicy(backendTLSPolicy *apisv1alpha2.BackendTLSPolicy, fieldManager string) (*BackendTLSPolicyApplyConfiguration, error) {
...
// Experimental!
func ExtractBackendTLSPolicyStatus(backendTLSPolicy *apisv1alpha2.BackendTLSPolicy, fieldManager string) (*BackendTLSPolicyApplyConfiguration, error) {
	return extractBackendTLSPolicy(backendTLSPolicy, fieldManager, "status")
}

func extractBackendTLSPolicy(backendTLSPolicy *apisv1alpha2.BackendTLSPolicy, fieldManager string, subresource string) (*BackendTLSPolicyApplyConfiguration, error) {
	b := &BackendTLSPolicyApplyConfiguration{}
	err := managedfields.ExtractInto(backendTLSPolicy, internal.Parser().Type("io.k8s.sigs.gateway-api.apis.v1alpha2.BackendTLSPolicy"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
